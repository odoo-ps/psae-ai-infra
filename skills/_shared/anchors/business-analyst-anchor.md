...
description: Audit a odoo-plan-development plan file against _shared/role_checklists/business_analyst.md. Flags drift in user-story shape, acceptance-criteria coverage, and non-functional requirement framing. Read-only. Use during odoo-plan-development's pre-ExitPlanMode anchor pass.
